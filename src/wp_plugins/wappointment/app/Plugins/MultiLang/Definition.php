...
class Definition implements PluginDefinition
{
    ...
    {
        return ['translatepress-multilingual/index.php' => \Wappointment\Plugins\MultiLang\TranslatePress::class, 'default' => \Wappointment\Plugins\MultiLang\NullMultiLang::class];
    }
}
