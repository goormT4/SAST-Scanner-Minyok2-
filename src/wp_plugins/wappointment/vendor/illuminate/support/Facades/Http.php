...
use WappoVendor\Illuminate\Http\Client\Factory;
/**
 ...
 * @method static \Illuminate\Http\Client\Response \WappointmentLv::head(string $url, array|string|null $query = null)
